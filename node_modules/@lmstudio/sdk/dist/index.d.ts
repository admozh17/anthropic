 ...
 * @public
 */
export declare interface LLMAccelerationConfig {
    /**
 ...
 * @public
 */
export declare type LLMAccelerationOffload = number | "auto";
 ...
 * @public
 */
export declare type LLMChatHistoryRole = "system" | "user" | "assistant";
...
/** @public */
export declare interface LLMCompletionOpts {
    /**
     * Additional configuration for the prediction. Will override the values set in the preset.
     */
...
export declare class LLMNamespace {
     ...
     */
    load(modelAddress: string, opts?: LLMLoadModelOpts): Promise<LLMModel>;
    /**
     ...
     */
    get(query: LLMModelQuery): LLMModel;
    /**
     ...
     */
    get(identifier: string): LLMModel;
}
