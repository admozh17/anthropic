...
class LMStudioClient {
    ...
    async guessBaseUrl() {
        return Promise.any(lms_common_1.lmsDefaultPorts.map(this.isLocalhostWithGivenPortLMStudioServer)).then(port => `ws://127.0.0.1:${port}`, () => {
            this.logger.throw((0, lms_common_1.text) `
          Failed to guess the base URL of the LM Studio server. We have tried to connect to the
          following addresses:

          ${lms_common_1.lmsDefaultPorts.map(port => `- 127.0.0.1:${port}`).join("\n")}

          Please make sure that LM Studio is running and the server is listening on one of the
          aforementioned addresses.

          If you are using a custom port and/or are reverse-proxying, you should pass the base URL
          to the LMStudioClient constructor like so:
    ...
    constructor(opts = {}) {
        const { logger, baseUrl, clientIdentifier, clientPasskey } = (0, lms_common_1.validateConstructorParamOrThrow)("LMStudioClient", "opts", constructorOptsSchema, opts);
        this.logger = logger ?? new lms_common_1.SimpleLogger("LMStudioClient");
        ...
        if (baseUrl === undefined) {
            resolvingBaseUrl = this.guessBaseUrl();
        }
        else {
        ...
        this.llm = new LLMNamespace_1.LLMNamespace(this.llmPort, this.logger);
...
function createAuthenticatedClientPort(backendInterface, wsAddress, apiNamespace, clientIdentifier, clientPasskey, logger) {
    let anyWindow;
    try {
        anyWindow = window;
    }
    ...
    if (anyWindow !== undefined && anyWindow.lmsHostedEnv !== undefined) {
        ...
        return new lms_communication_client_1.ClientPort(backendInterface, createAuthenticatedIpcTransportFactory(apiNamespace, anyWindow.lmsHostedEnv, clientIdentifier, clientPasskey), { parentLogger: logger });
    }
    else {
        return new lms_communication_client_1.ClientPort(backendInterface, createAuthenticatedWsTransportFactory(apiNamespace, wsAddress, clientIdentifier, clientPasskey), { parentLogger: logger });
    }
}
...
class LLMModel {
    ...
    complete(prompt, opts = {}) {
        ...
        [prompt, opts] = (0, lms_common_1.validateMethodParamsOrThrow)("LLMModel", "complete", ["prompt", "opts"], [zod_1.z.string(), completeOptsSchema], [prompt, opts]);
    ...
    respond(history, opts = {}) {
        ...
        [history, opts] = (0, lms_common_1.validateMethodParamsOrThrow)("LLMModel", "complete", ["history", "opts"], [lms_shared_types_1.llmChatHistorySchema, respondOptsSchema], [history, opts]);
        const { config = {}, structured } = opts;
        const [cancelEvent, emitCancelEvent] = lms_common_1.BufferedEvent.create();
        const { ongoingPrediction, finished, failed, push } = OngoingPrediction_1.OngoingPrediction.create(emitCancelEvent);
...
class LLMNamespace {
    /** @internal */
    constructor(llmPort, parentLogger) {
        this.llmPort = llmPort;
     ...
     */
    async load(modelAddress, opts = {}) {
        [modelAddress, opts] = (0, lms_common_1.validateMethodParamsOrThrow)("LLMNamespace", "load", ["modelAddress", "opts"], [lms_shared_types_1.reasonableKeyStringSchema, llmLoadModelOptsSchema], [modelAddress, opts]);
        ...
        const channel = this.llmPort.createChannel("loadModel", {
            ...
            switch (message.type) {
                ...
                `);
                    ...
                    resolve(new LLMModel_1.LLMModel(this.llmPort, { type: "sessionIdentifier", sessionIdentifier: message.sessionIdentifier }, this.logger));
                    break;
                }
                case "progress": {
                    ...
                    if (verbose) {
                        ...
                        if (now - lastVerboseCallTime > 500 || progress === 1) {
                            ...
                            this.logger.logAtLevel(verboseLevel, `Loading model ${modelAddress}, progress: ${progressText}%`);
     ...
     */
    unload(identifier) {
        (0, lms_common_1.validateMethodParamOrThrow)("LLMNamespace", "unload", "identifier", lms_shared_types_1.reasonableKeyStringSchema, identifier);
    ...
    get(param) {
        (0, lms_common_1.validateMethodParamOrThrow)("LLMNamespace", "get", "param", zod_1.z.union([lms_shared_types_1.reasonableKeyStringSchema, lms_shared_types_1.llmModelQuerySchema]), param);
        let query;
        ...
        if (query.address?.includes("\\")) {
            throw new Error((0, lms_common_1.text) `
...
class LazySignal extends Subscribable_1.Subscribable {
    constructor(upstreamSubscriber, equalsPredicate = (a, b) => a === b) {
        super();
        ...
        [this.signal, this.setValue] = Signal_1.Signal.create(LazySignal.NOT_AVAILABLE, fullEqualsPredicate);
    }
    /**
...
class Subscribable {
    ...
    deriveLazySignal(deriver, outputEqualsPredicate = (a, b) => a === b) {
        return new LazySignal_1.LazySignal(listener => {
            const unsubscribe = this.subscribe(data => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.toJSONSafeNumber = exports.text = exports.runOnDispose = exports.unwrapPromiseOfResult = exports.unwrapPromiseOfMaybeErrored = exports.promiseToResult = exports.promiseToMaybeErrored = exports.maybeErroredSchema = exports.createResultSchema = exports.removeUndefinedValues = exports.validateOrThrow = exports.validateMultipleOrThrow = exports.validateMethodParamsOrThrow = exports.validateMethodParamOrThrow = exports.validateConstructorParamsOrThrow = exports.validateConstructorParamOrThrow = exports.prettyPrintZod = exports.makePromise = exports.lmsDefaultPorts = exports.WaitQueue = exports.QueueClearedError = exports.PagerExitedError = exports.TimeoutTracker = exports.StreamablePromise = exports.SimpleLogger = exports.Signal = exports.Event = exports.BufferedEvent = exports.LazySignal = void 0;
const immer_1 = __webpack_require__(6392);
...
var prettyPrintZod_1 = __webpack_require__(6264);
Object.defineProperty(exports, "prettyPrintZod", ({ enumerable: true, get: function () { return prettyPrintZod_1.prettyPrintZod; } }));
Object.defineProperty(exports, "validateConstructorParamOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateConstructorParamOrThrow; } }));
Object.defineProperty(exports, "validateConstructorParamsOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateConstructorParamsOrThrow; } }));
Object.defineProperty(exports, "validateMethodParamOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateMethodParamOrThrow; } }));
Object.defineProperty(exports, "validateMethodParamsOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateMethodParamsOrThrow; } }));
Object.defineProperty(exports, "validateMultipleOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateMultipleOrThrow; } }));
Object.defineProperty(exports, "validateOrThrow", ({ enumerable: true, get: function () { return prettyPrintZod_1.validateOrThrow; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateConstructorParamsOrThrow = exports.validateConstructorParamOrThrow = exports.validateMethodParamsOrThrow = exports.validateMethodParamOrThrow = exports.validateMultipleOrThrow = exports.validateOrThrow = exports.prettyPrintZod = void 0;
const chalk_1 = __importDefault(__webpack_require__(8033));
const text_1 = __webpack_require__(7087);
/**
 ...
 */
function prettyPrintZod(rootObjectName, error) {
    return error.errors
        .map(e => {
        if (e.path.length === 0) {
...
exports.prettyPrintZod = prettyPrintZod;
/**
 ...
 */
function validateOrThrow(lead, rootObjectName, schema, value) {
 ...
 */
function validateMultipleOrThrow(leadProducer, rootObjectNames, schemas, values) {
...
exports.validateMultipleOrThrow = validateMultipleOrThrow;
/**
 ...
 * @throws An error if the value is invalid
 */
function validateMethodParamOrThrow(className, methodName, paramName, schema, value) {
...
exports.validateMethodParamOrThrow = validateMethodParamOrThrow;
/**
 * Validates multiple values against multiple schemas and throws an error if any of them are
 ...
 * @throws An error if any of the values are invalid
 */
function validateMethodParamsOrThrow(className, methodName, paramNames, schemas, values) {
    return validateMultipleOrThrow(erroredValues => {
    ...
    }, paramNames, schemas, values);
}
exports.validateMethodParamsOrThrow = validateMethodParamsOrThrow;
/**
 * Validates a value against a schema and throws an error if it's invalid. This is a convenience
 ...
 * @throws An error if the value is invalid
 */
function validateConstructorParamOrThrow(className, paramName, schema, value) {
    const functionCall = chalk_1.default.yellowBright((0, text_1.text) `
    ${className}(${chalk_1.default.redBright(paramName)})
  `);
    return validateOrThrow(`Invalid parameter(s) when constructing ${functionCall}`, paramName, schema, value);
}
exports.validateConstructorParamOrThrow = validateConstructorParamOrThrow;
/**
 * Validates multiple values against multiple schemas and throws an error if any of them are
 ...
 * @param values - The values to validate
 */
function validateConstructorParamsOrThrow(className, paramNames, schemas, values) {
    return validateMultipleOrThrow(erroredValues => {
        const coloredParamNames = paramNames.map((name, index) => erroredValues.has(index) ? chalk_1.default.redBright(name) : name);
        const functionCall = chalk_1.default.yellowBright((0, text_1.text) `
...
exports.validateConstructorParamsOrThrow = validateConstructorParamsOrThrow;
//
...
const lms_shared_types_1 = __webpack_require__(5790);
class ClientPort {
    constructor(backendInterface, factory, { parentLogger, } = {}) {
    ...
    receivedChannelSend(message) {
        ...
        ${(0, lms_common_1.prettyPrintZod)("message", parsed.error)}
      `);
            return;
        }
    ...
    receivedChannelError(message) {
        ...
        this.openChannels.delete(message.channelId);
        openChannel.errored((0, lms_shared_types_1.fromSerializedError)(message.error));
        this.updateOpenCommunicationsCount();
    }
    receivedRpcResult(message) {
        ...
        ${(0, lms_common_1.prettyPrintZod)("result", parsed.error)}
      `);
            return;
        }
    ...
    receivedRpcError(message) {
        ...
        ongoingRpc.reject((0, lms_shared_types_1.fromSerializedError)(message.error));
        this.ongoingRpcs.delete(message.callId);
        this.updateOpenCommunicationsCount();
    }
    ...
    createChannel(endpointName, param, onMessage) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fromSerializedError = exports.serializeError = exports.serializedLMSExtendedErrorSchema = void 0;
const zod_1 = __webpack_require__(6851);
...
exports.llmModelQuerySchema = zod_1.z.object({
    ...
    address: reasonable_1.reasonableKeyStringSchema.optional(),
});
...
function createSystemBackendInterface() {
    return new lms_communication_1.BackendInterface()
        ...
        returns: zod_1.z.array(lms_shared_types_1.downloadedModelSchema),
    });
}
